...
clc
 ...
 scatter(rollVol_b_0611,rollMean_b_0611,LineWidth=3);
...
scatter(rollVol_b_0611,rollMean_b_0611,LineWidth=3,DisplayName='Base benchmark');
xlim([-0.5 3]);
ylim([-0.5 2]);
hold off
...
%% No short selling 
 ...
 save Benchmark_2006-2011_Roll.mat